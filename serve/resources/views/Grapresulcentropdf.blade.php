...
<head>
    ...
    <title> Cantidad de casos por Centro </title>
<style>
...
<body>
    <section class="sec">
        ...
        <h1>Exportacion de datos Referentes a grafica de Cantidad de casos por Centro</h1>
