...
<body>
    <section class="sec">
        ...
        <h1>Exportacion de datos Referentes a grafica de Cantidad de Pacientes por ciudad</h1>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>nombre_madre</th>
                <th>apellidos</th>
                <th>ciudad_pertenencia </th>
            </tr>
        </thead>
        <tbody>
            @foreach($grapciudad as $grpc)
            <tr>
                <td>{{$grpc->id}}</td>
