...
class Registro_provinciasController extends Controller
{
    ...
    {
        return DB::select('SELECT r.id,r.hora, r.fecha, r.cod_tarjeta, r.cantidad_recibida, r.cantidad_entregada, c.nombre as nombre_centro, r.entregado_por, r.telefono, r.recibido_por FROM Registro_hospitales r JOIN Centros c ON r.id_centros = c.id
        ');
